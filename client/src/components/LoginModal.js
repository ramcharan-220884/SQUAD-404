      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all animate-in fade-in zoom-in duration-300 relative border border-white/20 flex flex-col h-auto">
        ...
        <div className="flex-1 p-6 lg:p-8 font-['Poppins']">
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-[#346b41]/5 text-[#346b41] text-[11px] font-extrabold uppercase tracking-[0.2em] mb-4">
              <span className="w-1.5 h-1.5 rounded-full bg-[#346b41] animate-pulse"></span>
              Secure Portal Access
            </div>

            {error && (
              <div className="bg-red-50 border-2 border-red-100 text-red-600 px-4 py-3 rounded-2xl w-full text-xs font-semibold flex items-center justify-start gap-3 mb-5 mt-2 animate-in fade-in slide-in-from-top-2 text-left">
