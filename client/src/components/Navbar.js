        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className={`px-5 py-2 rounded-full border text-sm font-bold active:scale-95 transition-all duration-200 ${
                scrolled
            ...
            <button
              ...
              className="px-5 py-2 rounded-full bg-indigo-600 text-white text-sm font-bold shadow hover:bg-indigo-700 active:scale-95 transition-all duration-200"
            >
              Sign Up
            </button>
          </div>
        ...
        <div className="flex flex-col items-center gap-4 px-6">
          ...
          <div className="flex flex-col w-full gap-2">
            <button
              ...
              className="w-full py-2.5 rounded-full border border-indigo-600 text-indigo-600 font-bold hover:bg-indigo-50 transition-colors"
            >
              Login
            </button>
            <button
