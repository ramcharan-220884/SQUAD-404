      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden transform transition-all animate-in fade-in zoom-in duration-300 relative border border-white/20 flex flex-col h-auto">
        ...
        <div className="flex-1 p-6 lg:p-8 font-['Poppins']">
          ...
          <div className="mb-8 flex flex-col items-center text-center">
            ...
            {!isSuccess && (
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-[#346b41]/5 text-[#346b41] text-[11px] font-extrabold uppercase tracking-[0.2em] mb-2">
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className="pl-12 w-full px-5 py-4 bg-gray-50/50 border-2 border-gray-100/80 rounded-2xl focus:bg-white focus:ring-[6px] focus:ring-[#346b41]/5 focus:border-[#346b41] outline-none transition-all duration-300 text-sm font-medium placeholder:text-gray-300"
                    />
                  </div>
                </div>
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        required
                        placeholder="••••••••"
                        className="pl-11 w-full px-4 py-4 bg-gray-50/50 border-2 border-gray-100/80 rounded-2xl focus:bg-white focus:ring-[6px] focus:ring-[#346b41]/5 focus:border-[#346b41] outline-none transition-all duration-300 text-sm font-medium placeholder:text-gray-300"
                      />
                    </div>
                  </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className={`w-full py-4.5 px-6 rounded-2xl text-white text-sm font-extrabold uppercase tracking-[0.2em] shadow-xl shadow-[#346b41]/20 transition-all active:scale-[0.98] mt-2 ${
                    loading
