...
export default function Register() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-xl overflow-hidden relative z-10 p-5 border border-gray-100 my-2 flex flex-col justify-center">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-3 py-1.5 border border-gray-300 rounded-md focus:ring-1 focus:ring-[#800000] focus:border-[#800000] outline-none transition-colors text-sm font-medium"
                placeholder=""
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                required
                className="pl-9 w-full px-3 py-1.5 border border-gray-300 rounded-md focus:ring-1 focus:ring-[#800000] focus:border-[#800000] outline-none transition-colors text-sm font-medium"
                placeholder=""
              />
            </div>
          </div>
          ...
          {role === "company" && (
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="2"
                className="w-full px-3 py-1.5 border border-gray-300 rounded-md focus:ring-1 focus:ring-[#800000] focus:border-[#800000] outline-none transition-colors resize-none text-sm font-medium"
              ></textarea>
            </div>
          )}
      ...
      <div className="mt-2 text-center z-10 flex flex-col gap-0.5 items-center">
